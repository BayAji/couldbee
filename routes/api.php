...
use App\Http\Middleware\ValidateRequester;
...
Route::middleware([ValidateRequester::class])->group(function () {
    // API User
    ...
    //route Transaction
    Route::get('/transaction/{id}/{type}', [TransactionController::class, 'index']);
